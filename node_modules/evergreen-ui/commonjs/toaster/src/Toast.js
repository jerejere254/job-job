...
var openAnimation = (0, _uiBox.keyframes)('openAnimation', {
  from: {
    opacity: 0,
...
var closeAnimation = (0, _uiBox.keyframes)('closeAnimation', {
  from: {
    transform: 'scale(1)',
    opacity: 1
  },
...
var Toast = /*#__PURE__*/(0, _react.memo)(function Toast(props) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_reactTransitionGroup.Transition, {
    ...
    return /*#__PURE__*/_react["default"].createElement(_uiBox["default"], (0, _extends2["default"])({}, animationStyles, {
      ref: transitionRef,
      "data-state": state,
    ...
    }, styles), /*#__PURE__*/_react["default"].createElement(_uiBox["default"], {
      ref: onRef,
      padding: 8
