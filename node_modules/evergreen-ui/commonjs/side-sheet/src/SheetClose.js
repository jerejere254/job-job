...
var sheetCloseStyles = (_sheetCloseStyles = {}, (0, _defineProperty2["default"])(_sheetCloseStyles, _constants.Position.RIGHT, _objectSpread({
...
}, withAnimations((0, _uiBox.keyframes)('rotate360InAnimation', {
  from: {
...
}), (0, _uiBox.keyframes)('rotate360OutAnimation', {
  from: {
    transform: 'translateX(-100%) rotate(0deg)'
  },
  to: {
  ...
  marginTop: 12,
  transform: 'translateX(100%)'
}, withAnimations((0, _uiBox.keyframes)('leftRotate360InAnimation', {
  from: {
    transform: 'translateX(-100%) rotate(0deg)'
  },
  to: {
...
}), (0, _uiBox.keyframes)('leftRotate360OutAnimation', {
  from: {
    transform: 'translateX(100%) rotate(0deg)'
  },
  to: {
...
}, withAnimations((0, _uiBox.keyframes)('topRotate360InAnimation', {
  from: {
...
}), (0, _uiBox.keyframes)('topRotate360OutAnimation', {
  from: {
  ...
  marginBottom: 12,
  transform: 'translateY(0)'
}, withAnimations((0, _uiBox.keyframes)('bottomRotate360InAnimation', {
  from: {
    transform: 'translateY(200%) rotate(0deg)'
  },
  to: {
...
}), (0, _uiBox.keyframes)('bottomRotate360OutAnimation', {
  from: {
    transform: 'translateY(0%) rotate(0deg)'
  },
  to: {
...
var SheetClose = /*#__PURE__*/function (_PureComponent) {
  ...
  (0, _createClass2["default"])(SheetClose, [{
    ...
    value: function render() {
      ...
      }, sheetCloseStyles[position], sharedStyles, props), /*#__PURE__*/_react["default"].createElement(_icons.CrossIcon, {
        color: "#fff"
      }));
    }
  }]);
