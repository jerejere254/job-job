...
var animationStylesClass = (_animationStylesClass = {}, (0, _defineProperty2["default"])(_animationStylesClass, _constants.Position.LEFT, _objectSpread({
...
}, withAnimations((0, _uiBox.keyframes)('anchoredLeftSlideInAnimation', {
  from: {
    transform: 'translateX(-100%)'
  },
  to: {
...
}), (0, _uiBox.keyframes)('anchoredLeftSlideOutAnimation', {
  from: {
    transform: 'translateX(0)'
  },
  to: {
  ...
  transform: 'translateX(100%)'
}, withAnimations((0, _uiBox.keyframes)('anchoredRightSlideInAnimation', {
  from: {
    transform: 'translateX(100%)'
  },
  to: {
...
}), (0, _uiBox.keyframes)('anchoredRightSlideOutAnimation', {
  from: {
    transform: 'translateX(0)'
  },
  to: {
...
}, withAnimations((0, _uiBox.keyframes)('anchoredTopSlideInAnimation', {
  from: {
    transform: 'translateY(-100%)'
  },
  to: {
...
}), (0, _uiBox.keyframes)('anchoredTopSlideOutAnimation', {
  from: {
    transform: 'translateY(0)'
  },
  to: {
  ...
  transform: 'translateY(100%)'
}, withAnimations((0, _uiBox.keyframes)('anchoredBottomSlideInAnimation', {
  from: {
    transform: 'translateY(100%)'
  },
  to: {
...
}), (0, _uiBox.keyframes)('anchoredBottomSlideOutAnimation', {
  from: {
    transform: 'translateY(0)'
  },
  to: {
